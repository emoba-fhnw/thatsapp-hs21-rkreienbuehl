...
class SystemMessageConnect(id: UUID, senderID: UUID, subType: String, username: String, profileImageLink: String, date: LocalDateTime, metaInfo: String) : Message(id, senderID, date, metaInfo) {
    ...
    constructor(id: UUID, senderID: UUID, subType: String, username: String, profileImageLink: String, date: String, metaInfo: String) :
            this(id, senderID, subType, username, profileImageLink, date.dateFromJSON(), metaInfo)
    constructor(senderID: UUID, username: String, subType: String, profileImageLink: String, metaInfo: String) :
            this(UUID.randomUUID(), senderID, subType, username, profileImageLink, LocalDateTime.now(), metaInfo)
